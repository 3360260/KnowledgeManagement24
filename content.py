...
class Content(QWidget):
    ...
    def initUI(self):
        ...
        big_box.setStyleSheet("background-color: lightgrey; padding: 10px; border-bottom: 2px solid ##D66A28;")
        ...
        small_box1.setStyleSheet("background-color: lightblue; padding: 10px; border-top: 2px solid ##D66A28;")
        ...
        small_box2.setStyleSheet("background-color: lightgreen; padding: 10px; border-top: 2px solid ##D66A28;")
