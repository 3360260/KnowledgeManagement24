...
class Application(QMainWindow):
    ...
    def initUI(self):
        ...
        header.setStyleSheet("color: white;")  # Set font color to white
        ...
        menu.setStyleSheet("color: white;")  # Set font color to white
        ...
        initial_content.setStyleSheet("color: white;")  # Set font color to white
        ...
        footer.setStyleSheet("color: white;")  # Set font color to white
